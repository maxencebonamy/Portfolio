...
const Home = ({lang}: HomeProps) => {
    return (
        <section className="w-full h-screen flex items-center justify-center flex-col gap-3">
            ...
            />
            <Logo className="z-10 w-1/3 fill-dark dark:fill-light transition-colors duration-500 mb-3" />
            <span className="flex items-center flex-col lg:flex-row justify-center gap-6">
